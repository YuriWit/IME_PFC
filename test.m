...
tp.radiusVector2 = [1;0;0];
tp.radiusVector3 = [0.707;0.707;0];
tp.radiusVector4 = [0.91;0.41;0];
tp.angularVelocityVector1 = [0;0;1500] *2*pi/60;
tp.angularVelocityVector2 = -1*[0;0;1200] *2*pi/60;
tp.angularVelocityVector3 = [0;0;1400] *2*pi/60;
tp.angularVelocityVector4 = -1*[0;0;1400] *2*pi/60;
