%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Script to find the best fit radar cross section for quadcopter
...
enviroment = phased.FreeSpace('PropagationSpeed',c,...
    'OperatingFrequency',fc,'TwoWayPropagation',true,'SampleRate',fs);
...
tp.meanBladeRCS = [.08];
tp.bladePoints = [.4]; % poins along blade (0 - 1)
...
%% search space single point representation
